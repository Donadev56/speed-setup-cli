...
let installFutures;
let FDtype;
const logInstallBegining = (dep) => {
    console.log(`\n🔧 Installing ${dep} and its type definitions...`);
};
const logSuccessInstall = (dep) => {
...
let installExpressPrompt;
let installDotenvPrompt;
let installJestPromt;
let installESLintPrompt;
let installPrettierPromt;
